...
<body>
    <form name="aspnetForm" enctype="multipart/form-data" method="post" action="<?=$GLOBALS['admin_root']?>index.php?action=news&method=addsure&catetype=<?=$this->catetype?>" onsubmit="javascript:return WebForm_OnSubmit();" id="aspnetForm">
        ...
        <td>
            <table width="100%" border="0" align="center" style="border: 1px solid #B2C8DF;background:#fff;">
                ...
                <tr>
                    ...
                    <td>
                        <input name="title" type="text" maxlength="250" id="title" style="width:470px;" />
                ...
                <tr>
                    ...
                    <td>
                        <input name="tiny_title" type="text" maxlength="250" id="tiny_title" style="width:100px;" />
                        <span id="ctl00_ContentPlaceHolder1_RequiredFieldValidator1" style="color:Red;visibility:hidden;">*</span>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="short_title" rows="2" cols="20" id="short_title" style="height:69px;width:470px;"></textarea>
                ...
                <tr>
                    ...
                    <td>
                        <input name="key_word" type="text" maxlength="200" id="key_word" style="width:253px;" />
                ...
                <tr>
                    ...
                    <td>
                        <input name="show_order" type="text" maxlength="200" id="show_order" style="width:60px;" />
                        <span id="ctl00_ContentPlaceHolder1_RequiredFieldValidator4" style="color:Red;visibility:hidden;">*</span>
                    </td>
                </tr>
                <?php 
                ...
                <tr>
                    ...
                    <td>
                         <input name="news_date" type="text" value="" maxlength="16" id="news_date" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',skin:'whyGreen'})" style="width:175px;" />
                ...
                <tr>
                    ...
                    <td><textarea rows="10" cols="10" id="content" name="content" style="width:600px;height:400px;"></textarea></td>
                </tr>
                <?php 
                }
                ...
                <tr>
                    ...
                    <td><input name="link" type="text" maxlength="200" id="link" style="width:470px;" /></td>
                </tr>
                <?php 
                }
                ?>
