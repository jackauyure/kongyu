...
<div></div>
	...
	<tr><td valign="middle" align="center">
		<table border="0" cellspacing="1" cellpadding="1" width="681" height="359" align="center"  background="images/login.jpg" style='background-repeat:no-repeat;background-position:center'>
		    <tr>
                    ...
                    <table border="0" cellpadding="0" width="400">
                        ...
                        <tr>
                            ...
                            <td align="Left" style="width:300px;">
                                ...
                                <span id="UserNameRequired" title="必须填写“用户名”。" style="color:Red;visibility:hidden;">*</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td align="Left">
                                ...
                                <span id="PasswordRequired" title="必须填写“密码”。" style="color:Red;visibility:hidden;">*</span>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <span class="titleFont" id="Label1">验证码：</span></td>
                            <td height="22" align="Left">
                                <input type="text" style="width:50px;" id="checkcode" maxlength="4" name="checkcode">
                                <span style="color:Red;visibility:hidden;" title="必须填写“验证码”。" id="RequiredFieldValidator1">*</span>
                                <img width="46" height="20" onclick="this.src=this.src+'&'" alt="看不清？点击更换" src="<?=$GLOBALS['www_root']?>index.php?method=getCode" style="cursor:hand;" id="imgVerify">
                            </td>
