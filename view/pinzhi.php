...
<table id="__01" width="1024" height="744" border="0" cellpadding="0" cellspacing="0" align="center">
	<tr>
		<td colspan="3">
			<img src="<?=$GLOBALS['style']?>images/pinzhi_01.gif" width="1024" height="338" alt="" usemap="#MapTop"></td>
	</tr>
	<tr>
		<td rowspan="2">
			<img src="<?=$GLOBALS['style']?>images/pinzhi_02.gif" width="385" height="171" alt=""></td>
		<td width="419" height="170" background="<?=$GLOBALS['style']?>images/pinzhi_03.gif"><?=$nr['content']?></td>
		<td rowspan="2">
			<img src="<?=$GLOBALS['style']?>images/pinzhi_04.gif" width="220" height="171" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="<?=$GLOBALS['style']?>images/pinzhi_05.gif" width="419" height="1" alt=""></td>
	</tr>
	<tr>
		<td colspan="3">
			<img src="<?=$GLOBALS['style']?>images/pinzhi_06.gif" width="1024" height="235" alt=""></td>
	</tr>
