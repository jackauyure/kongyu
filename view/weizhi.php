...
<table id="__01" width="1024" height="744" border="0" cellpadding="0" cellspacing="0" align="center">
	<tr>
		<td colspan="3">
			<img src="<?=$GLOBALS['style']?>images/shebei_01.gif" width="1024" height="336" alt="" usemap="#MapTop"></td>
	</tr>
	<tr>
		<td>
			<img src="<?=$GLOBALS['style']?>images/shebei_02.gif" width="386" height="136" alt=""></td>
		<td background="<?=$GLOBALS['style']?>images/shebei_03.gif" width="437" height="136"><?=$nr['content']?></td>
		<td>
			<img src="<?=$GLOBALS['style']?>images/shebei_04.gif" width="201" height="136" alt=""></td>
	</tr>
	<tr>
		<td colspan="3">
			<img src="<?=$GLOBALS['style']?>images/shebei_05.gif" width="1024" height="272" alt=""></td>
	</tr>
	<tr>
		<td colspan="3">
			<img src="<?=$GLOBALS['style']?>images/shebei_06.gif" width="1024" height="24" alt=""></td>
	</tr>
</table>
<map name="MapTop">
