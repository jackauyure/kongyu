...
<table id="__01" width="1024" height="744" border="0" cellpadding="0" cellspacing="0" align="center">
	<tr>
		<td colspan="3">
			<img src="<?=$GLOBALS['style']?>images/xinxibaohu_01.gif" width="1024" height="338" alt="" usemap="#MapTop"></td>
	</tr>
	<tr>
		<td>
			<img src="<?=$GLOBALS['style']?>images/xinxibaohu_02.gif" width="387" height="226" alt=""></td>
		<td width="439" height="226" background="<?=$GLOBALS['style']?>images/xinxibaohu_03.gif"><?=$nr['content']?></td>
		<td>
			<img src="<?=$GLOBALS['style']?>images/xinxibaohu_04.gif" width="198" height="226" alt=""></td>
	</tr>
	<tr>
		<td colspan="3">
			<img src="<?=$GLOBALS['style']?>images/xinxibaohu_05.gif" width="1024" height="183" alt=""></td>
	</tr>
