...
<table id="__01" width="1024" height="744" border="0" cellpadding="0" cellspacing="0" align="center">
	<tr>
		<td colspan="3">
			<img src="<?=$GLOBALS['style']?>images/about_01.gif" width="1024" height="135" alt="" usemap="#MapTop"></td>
	</tr>
	<tr>
		<td>
			<img src="<?=$GLOBALS['style']?>images/about_02.gif" width="263" height="304" alt=""></td>
		<td valign="top" align="left" width="417" background="<?=$GLOBALS['style']?>images/about_03.gif"><?=$nr['content']?></td>
		<td>
			<img src="<?=$GLOBALS['style']?>images/about_04.gif" width="344" height="304" alt=""></td>
	</tr>
	<tr>
		<td colspan="3">
			<img src="<?=$GLOBALS['style']?>images/about_05.gif" width="1024" height="305" alt=""></td>
	</tr>
