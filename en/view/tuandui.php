...
<table id="__01" border="0" cellpadding="0" cellspacing="0" align="center">
	<tr>
		<td colspan="3">
			<img src="<?=$GLOBALS['style']?>images/team_01.gif" alt="" usemap="#MapTop"></td>
	</tr>
	<tr>
		<td>
			<img src="<?=$GLOBALS['style']?>images/team_02.gif" alt="" usemap="#Left"></td>
		<td background="<?=$GLOBALS['style']?>images/team_03.gif"><?=$nr['content']?></td>
		<td>
			<img src="<?=$GLOBALS['style']?>images/team_04.gif" alt=""></td>
	</tr>
	<tr>
		<td colspan="3">
			<img src="<?=$GLOBALS['style']?>images/team_05.gif" alt=""></td>
	</tr>
...
<map name="Left" id="Left">
  <area shape="rect" coords="270,10,351,35" href="<?=$GLOBALS['url'][9]?>">
  <area shape="rect" coords="273,46,353,71" href="<?=$GLOBALS['url'][10]?>">
  <area shape="rect" coords="270,75,350,104" href="<?=$GLOBALS['url'][11]?>">
  <area shape="rect" coords="268,109,351,138" href="<?=$GLOBALS['url'][12]?>">
  <area shape="rect" coords="264,142,350,174" href="<?=$GLOBALS['url'][13]?>">
</map>
</body>
</html>