...
<table id="__01"  border="0" cellpadding="0" cellspacing="0" align="center">
	<tr>
		<td colspan="3">
			<img src="<?=$GLOBALS['style']?>images/Quality_01.gif" alt="" usemap="#MapTop"></td>
	</tr>
	<tr>
		<td>
			<img src="<?=$GLOBALS['style']?>images/Quality_02.gif" alt=""></td>
		<td background="<?=$GLOBALS['style']?>images/Quality_03.gif"><?=$nr['content']?></td>
		<td>
			<img src="<?=$GLOBALS['style']?>images/Quality_04.gif" alt=""></td>
	</tr>
	<tr>
		<td colspan="3">
			<img src="<?=$GLOBALS['style']?>images/Quality_05.gif" alt=""></td>
	</tr>
	<tr>
		<td colspan="3">
			<img src="<?=$GLOBALS['style']?>images/Quality_06.gif" alt=""></td>
	</tr>
