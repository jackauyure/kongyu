...
<table id="__01" border="0" cellpadding="0" cellspacing="0" align="center">
	<tr>
		<td colspan="3">
			<img src="<?=$GLOBALS['style']?>images/CSR_01.gif" alt="" usemap="#MapTop"></td>
	</tr>
	<tr>
		<td>
			<img src="<?=$GLOBALS['style']?>images/CSR_02.gif" alt=""></td>
		<td background="<?=$GLOBALS['style']?>images/CSR_03.gif"><?=$nr['content']?></td>
		<td>
			<img src="<?=$GLOBALS['style']?>images/CSR_04.gif" alt=""></td>
	</tr>
	<tr>
		<td colspan="3">
			<img src="<?=$GLOBALS['style']?>images/CSR_05.gif"  alt=""></td>
	</tr>
