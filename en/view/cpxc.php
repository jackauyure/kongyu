...
<table id="__01" border="0" cellpadding="0" cellspacing="0" align="center">
	<tr>
		<td colspan="3">
			<img src="<?=$GLOBALS['style']?>images/productablum_01.gif" alt="" usemap="#MapTop"></td>
	</tr>
	<tr>
		<td>
			<img src="<?=$GLOBALS['style']?>images/productablum_02.gif" alt="" usemap="#Left"></td>
		<td width="742" height="1246" valign="top">
		...
		<td>
			<img src="<?=$GLOBALS['style']?>images/productablum_04.gif" alt=""></td>
	</tr>
	<tr>
		<td colspan="3">
			<img src="<?=$GLOBALS['style']?>images/productablum_05.gif" alt=""></td>
	</tr>
